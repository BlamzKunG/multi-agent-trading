...
3. สำหรับสินค้าทองคำ (XAUUSD) การตั้ง LIMIT Order ห้ามห่างจากราคาปัจจุบันน้อยกว่า 2.0 USD และควรเน้นจุดกลับตัวที่มีประสิทธิภาพสูงสุด
...
3. สำหรับทองคำ (XAUUSD) การตั้ง Pending Order ต้องห่างจากราคาปัจจุบันอย่างน้อย 3.50 - 6.00 USD ขึ้นไปเพื่อความปลอดภัย
...
3. สำหรับทองคำ (XAUUSD) ในโหมด Swing Trade การวางแผน Pending LIMIT ควรกำหนดจุดห่างราคาตลาดปัจจุบันอย่างน้อย 8.0 - 15.0 USD ณ บริเวณกำแพงแนวต้านรับหลักเพื่อ R:R ที่คุ้มค่าสูงสุด
