...
1. หาก Volatility Guard หรือ Spread Guard รายงานสถานะ FAIL ให้ปฏิเสธและสรุปตอบเป็น HOLD ทันที (ตั้งค่า lot, entry, sl, tp เป็น 0.0)
2. หากข้อเสนอของ Trend Agent และ Price Action Agent ขัดแย้งกัน หรือไม่มีสัญญาณกลับตัวชัดเจนบนแท่ง M5 ให้ตอบเป็น HOLD ทันที
